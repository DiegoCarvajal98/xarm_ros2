...
: ${AMENT_CURRENT_PREFIX:="/overlay_ws/install/micro_ros_agent"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/micro_ros_agent/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/micro_ros_agent/environment/path.sh"
