...
: ${AMENT_CURRENT_PREFIX:="/overlay_ws/install/xarm_moveit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/xarm_moveit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/xarm_moveit_config/environment/path.sh"
