...
: ${AMENT_CURRENT_PREFIX:="/overlay_ws/install/xarm_gazebo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/xarm_gazebo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/xarm_gazebo/environment/path.sh"
